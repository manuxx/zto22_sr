...
namespace Training.DomainClasses
{
    public class PetShop
    {
        ...
        public IEnumerable<Pet> AllCatsOrDogs() => 
            _petsInTheStore.ThatSatisfy(pet => pet.species == Species.Cat || pet.species == Species.Dog);
        public IEnumerable<Pet> AllPetsButNotMice() => 
            _petsInTheStore.ThatSatisfy(pet => pet.species != Species.Mouse);
        public IEnumerable<Pet> AllPetsBornAfter2010() => 
            _petsInTheStore.ThatSatisfy(pet => pet.yearOfBirth > 2010);
        public IEnumerable<Pet> AllDogsBornAfter2010() => 
            _petsInTheStore.ThatSatisfy(pet => pet.species == Species.Dog && pet.yearOfBirth > 2010);
        public IEnumerable<Pet> AllMaleDogs() => 
            _petsInTheStore.ThatSatisfy(pet => pet.sex == Sex.Male && pet.species == Species.Dog);
